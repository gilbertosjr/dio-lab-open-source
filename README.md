...
> [!NOTE]   
> Por exemplo, a URL https://github.com/gilbertosjr/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`gilbertosjr`" para a contribuição no repositório `dio-lab-open-source`.
